...
- 项目自述（现状）：[`docs/v1/overview.md`](overview.md)
- 一期设计（v1）：[`docs/v1/design.md`](design.md)
- 一期实现进度（v1，自述）：[`docs/v1/implementation.md`](implementation.md)
- 用户资料、GitHub 同步策略与只读评论：[`docs/v1/user-profile-sync-readonly-comments.md`](user-profile-sync-readonly-comments.md)
...
- 管理写接口与鉴权说明：[`docs/管理写接口与鉴权.md`](../管理写接口与鉴权.md)

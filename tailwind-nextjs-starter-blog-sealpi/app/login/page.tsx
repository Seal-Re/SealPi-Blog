      ...
      <div className="border-wb-rule-soft/80 bg-wb-canvas/90 w-full max-w-lg rounded-[2rem] border p-8 shadow-xl backdrop-blur">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          ...
          >
            <button
              type="submit"
              className="bg-wb-ink text-wb-paper hover:bg-wb-ink-soft inline-flex w-full items-center justify-center rounded-full px-6 py-3 text-sm font-semibold transition dark:bg-white dark:text-gray-950 dark:hover:bg-gray-200"
            >
              使用 GitHub 继续
            </button>
          </form>

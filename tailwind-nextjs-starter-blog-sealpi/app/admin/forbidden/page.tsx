...
export default function AdminForbiddenPage() {
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden p-6 sm:p-10">
      ...
      <div className="absolute inset-0 -z-10 bg-white/35 backdrop-blur-2xl dark:bg-black/35" />
      <div className="w-full max-w-2xl rounded-[2rem] border border-rose-200/70 bg-white/85 p-8 shadow-[0_24px_80px_-42px_rgba(225,29,72,0.35)] backdrop-blur-xl dark:border-rose-900/50 dark:bg-gray-950/65">
        ...
        <h1 className="mt-5 text-3xl font-black tracking-tight text-gray-950 sm:text-4xl dark:text-white">

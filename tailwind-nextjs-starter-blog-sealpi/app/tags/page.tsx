...
export default async function Page() {
  ...
  return (
    <>
      <div className="divide-wb-rule-soft flex flex-col items-start justify-start divide-y md:flex-row md:items-center md:justify-center md:space-x-6 md:divide-y-0">
        <div className="space-x-2 pt-6 pb-8 md:space-y-5">
          <h1 className="font-fraunces text-wb-ink md:border-wb-rule-soft text-3xl font-medium tracking-tight italic sm:text-4xl md:border-r-2 md:px-6 md:text-6xl">
            标签
          </h1>
        </div>

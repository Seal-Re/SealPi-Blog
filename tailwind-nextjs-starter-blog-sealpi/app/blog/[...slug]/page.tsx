...
function resolveOgImages(article: AdminArticle) {
  if (article.coverImageUrl) {
    const url = article.coverImageUrl.includes('http')
      ? article.coverImageUrl
      : `${siteMetadata.siteUrl}${article.coverImageUrl}`
    return [{ url }]
  }
  // No cover image — point to the per-article dynamic OG image generated by
  // app/blog/[...slug]/opengraph-image.tsx so social cards show branded content.
  return [{ url: `${siteMetadata.siteUrl}/blog/${article.url}/opengraph-image` }]
}
